module.exports = {
  Admins: ["219492687701737473"], // Admins of the bot, I don't know what this do. -Darren.
  ...
  CookieSecret: process.env.CookieSecret || "JeyM1 not stealink", // A cookie for you, cookie for me. make sure you change this value!
  IconURL:
    "https://i.pinimg.com/originals/c6/8f/d3/c68fd3c377f7cc6ed90cbea037483692.gif", // URL of all embed author icons | Dont edit unless you dont need that Music CD Spining
  ...
  Presence: {
    ...
    name: "Playink some music..", // The message shown
